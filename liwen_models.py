...
class Decoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, output_dimension):
        ...
        self.layers = nn.Sequential(
            ...
            DoubleConv1d(out_channels, out_channels, k=3, s=1),
            DoubleConv1d(out_channels, out_channels, k=3, s=1),
            nn.Conv1d(out_channels, output_dimension, kernel_size=1, stride=1)
        )
...
class PatchGan(nn.Module):
    def __init__(self, in_channel=59, ndf=64):
...
class Unet_Decoder(nn.Module):
    def __init__(self, in_channels, out_channels, output_dimension, batch_size, device):
